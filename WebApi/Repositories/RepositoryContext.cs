...
namespace WebApi.Repositories
{
	...
	{
		public RepositoryContext(DbContextOptions options) : base(options) //base ifadesi dbcontexti temsil ediyor, dbcontextteki baglanti dizesini kullanacagimizi belirtiyorz.
		{
