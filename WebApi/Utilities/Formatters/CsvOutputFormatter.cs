...
namespace WebApi.Utilities.Formatters
{
	public class CsvOutputFormatter : TextOutputFormatter
	{
		...
		{
			//gelen type BookDto veya Liste hali ise csv formatinda yazilabilecegini, aksi halde yazilamayacagini kontrol edelim
		...
		private static void FormatCsv(StringBuilder buffer, BookDto book) //csv formati burada uretilir
		{
		...
		public override async Task WriteResponseBodyAsync(OutputFormatterWriteContext context, Encoding selectedEncoding)
		{
			...
			if (context.Object is IEnumerable<BookDto>) //liste geldiyse
			{
